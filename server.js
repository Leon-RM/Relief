  ...
  try {
    ...
    if (!process.env.OPENROUTER_API_KEY) {
      return res.status(500).json({
        ...
        comfortMessage: 'AI รับฟังคุณอยู่ พร้อมให้กำลังใจ 💙✨'
      });
    }
    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'คุณคือผู้รับฟังที่เข้าใจและเห็นอกเห็นใจนักเรียนที่ต้องการปลดปล่อยความรู้สึก ตอบกลับด้วยข้อความสั้นๆ และให้กำลังใจ ที่ทำให้พวกเขารู้สึกว่ามีคนรับฟังและเข้าใจ ใช้อีโมจิอย่างเป็นธรรมชาติและเหมาะสม (2 ตัว) เพื่อให้ข้อความดูอบอุ่นและเป็นกันเองและให้คำแนะนำอย่างเหมาะสมและทำตามได้จริง ทั้งหมดไม่เกิน 2 - 3 ประโยค'
          },
          {
            role: 'user',
            content: message

    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'คุณคือผู้รับฟังที่เข้าใจและเห็นอกเห็นใจนักเรียนที่ต้องการปลดปล่อยความรู้สึก ตอบกลับด้วยข้อความสั้นๆ อบอุ่น และให้กำลังใจ (ไม่เกิน 1-2 ประโยค) ที่ทำให้พวกเขารู้สึกว่ามีคนรับฟังและเข้าใจ ใช้น้ำเสียงที่อ่อนโยน เข้าใจ และให้กำลังใจ ใช้อีโมจิอย่างเป็นธรรมชาติและเหมาะสม (2-3 ตัว) เพื่อให้ข้อความดูอบอุ่นและเป็นกันเอง'
          },
          {
            role: 'user',
            content: message
